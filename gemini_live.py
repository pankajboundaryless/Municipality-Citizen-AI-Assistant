...
class GeminiLive:
    ...
    _DEFAULT_SYSTEM = (
        ...
        "Help citizens with inquiries about ID documents, passports, work permits, and construction permits."
    )

    def __init__(self, api_key, model, input_sample_rate, system_instruction=None, tools=None, tool_mapping=None):
