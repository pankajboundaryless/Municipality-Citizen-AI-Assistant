...
# /home/site exists on Azure App Service and persists across restarts
DB_PATH = os.getenv("DB_PATH", "/home/citizen_sessions.db" if os.path.isdir("/home/site") else "citizen_sessions.db")
